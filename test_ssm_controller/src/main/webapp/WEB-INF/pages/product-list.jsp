...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/plugins/jvectormap/jquery-jvectormap-1.2.2(1).css">
<link rel="stylesheet"
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				...
				<ol class="breadcrumb">
					...
					<li><a href="${pageContext.request.contextPath}/product/findAll">数据管理</a></li>
								...
								<div class="form-group form-inline">
									<div class="btn-group">
										...
										<button type="button" class="btn btn-default" title="删除">
											<i class="fa fa-trash-o" id="del"></i> 删除
										</button>
